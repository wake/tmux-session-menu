...
var file_tsm_v1_tsm_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_tsm_v1_tsm_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
...
func file_tsm_v1_tsm_proto_init() {
	...
	file_tsm_v1_tsm_proto_msgTypes[15].OneofWrappers = []any{
